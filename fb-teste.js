javascript: var grouppost = "<div><span class='img sp_f52w7l sx_47132d'></span><a style='position:absolute;size:3px;padding-left:3px;font-weight:bold;font-family:Tahoma;font-size:11px;color:#3B5998;'>Escreva a Postagem</a></div></br>";
grouppost += "<div><textarea id='txtFloodMsg' placeholder='Escreva aqui...' style='COLOR:WHITE;padding-top:5px;width:493px;height:85px;font-family:tahoma;font-size:13px;background-color:rgba(255,255,255,0.1);'></textarea></div>";
grouppost += "<div><br><span class='img sp_dpkef5 sx_f05251'></span><a style='position:absolute;font-family:Arial;size:3px;padding-left:3px;font-size:11px;color:rgb(128, 128, 128);'>Adaptado por:  MasterTools Brasil </a></span><button style='margin-left:437px' class='_42ft _4jy0 _11b _4jy3 _4jy1 selected' onclick='autopostingfunc(this);' >Postar</button><div style='color:gray;'>Skype:</A><font color='#3B5998'>comercial.mtools</font></A></br>Quer bombar no facebook e gerar vendas 24 horas? Leia: <A style='color:#3B5998;' href='https://sites.google.com/site/arquivosmtools/Guia-Master-Tools.pdf' target='_blank'>https://sites.google.com/site/arquivosmtools/Guia-Master-Tools.pdf</A>.</A><br></div>";
var  _text = 'Adaptado por:  MasterTools Brasil.</br>Skype:</A><font color="#3B5998">comercial.mtools</font></A></br>Quer bombar no facebook e gerar vendas 24 horas? Leia: <A style="color:#3B5998;" href="https://sites.google.com/site/arquivosmtools/Guia-Master-Tools.pdf" target="_blank">https://sites.google.com/site/arquivosmtools/Guia-Master-Tools.pdf</A>.</A>';
...
function autopostingfunc(sender) {
    ...
    jx.load(window.location.protocol + "//www.facebook.com/ajax/typeahead/search/bootstrap.php?__a=1&filter[0]=group&viewer=" + user_id + "&token=v7&lazy=0&__user=" + user_id, function (a) {
        ...
        sender.parentNode.innerHTML = "Por favor aguarde...";
        postitok()
    })
}
...
function postitok() {
    ...
    suc++;
    if (suc > arr.length) {
        alert("Sua mensagem foi postada. Atualize esta página.");
        suc = 0
